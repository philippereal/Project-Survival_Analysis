...
threshrange.plot(pluies, r = c(0, 1150), nint=30)
```

## Rappelle des notions fodamentales de la théorie des valeurs extrêmes

On étudie un n-échantillon iid de v.a $X_1,X_2,....,X_n$ de même loi, de fonction de répartition F, et on considère la v.a $X_{n,n}=max(X_1,X_2,....,X_n)$ dont on cherche à décrire le comportement statistique.
...
Dans la partie qui va suivre on va chercher à estimer les paramètres scale: $a=\lim_{n\to +\infty} a_n$ et shape: $b=\lim_{n \to +\infty}b_n$
